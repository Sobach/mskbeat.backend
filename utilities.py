...
def create_mysql_tables():
	...
	tabs = [
		...
		"""CREATE TABLE `events` (`id` varchar(40) CHARACTER SET utf8mb4 NOT NULL DEFAULT '', `start` datetime DEFAULT NULL, `msgs` int(11) DEFAULT NULL, `dumps` longtext, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;""",
